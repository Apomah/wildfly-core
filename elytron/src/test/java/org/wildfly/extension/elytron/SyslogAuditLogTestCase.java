...
public class SyslogAuditLogTestCase extends AbstractSubsystemTest {
    ...
    private final int RECONNECT_TIMEOUT = 10;
    ...
    public void testZeroReconnectAttemptsBadHost() {
        ...
        assertCorrectError(response, new String[] {"ELY11009", "0"});
        assertFailed(response);
    }
    ...
    public void testNumberedReconnectAttemptsBadHost() {
        ...
        ModelNode response = services.executeOperation(badHostUdpOperation);
        assertCorrectError(response, new String[] {"ELY11009", Integer.toString(RECONNECT_NUMBER)});
        assertFailed(response);
    }
